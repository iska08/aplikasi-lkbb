...
class NilaipbbdantonpurnaController extends Controller
{
    protected $limit = 10;
    ...
    public function store(NilaipbbdantonStoreRequest $request)
    {
        ...
        return redirect('/dashboard/pbb-danton/purna')->with('success', 'Nilai berhasil ditambahkan!');
    }
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($nilaipbbdantons->exists()) {
            ...
            return redirect('/dashboard/pbb-danton/purna')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/pbb-danton/purna')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}