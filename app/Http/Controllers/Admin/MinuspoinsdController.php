...
class MinuspoinsdController extends Controller
{
    protected $limit = 10;
    ...
    public function index()
    {
        ...
        return view('pages.admin.minuspoin.sd.data', [
    ...
    public function create()
    {
        ...
        return view('pages.admin.minuspoin.sd.create', [
    ...
    public function store(MinuspoinStoreRequest $request)
    {
        ...
        return redirect('/dashboard/minus-poin/sd')->with('success', 'Pengurangan Nilai Berhasil Ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.minuspoin.sd.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/dashboard/minus-poin/sd')->with('success', 'Pengurangan Nilai Berhasil Diperbarui!');
    }
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($minuspoins->exists()) {
            ...
            $minuspoins->delete();
            return redirect('/dashboard/minus-poin/sd')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/minus-poin/sd')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}