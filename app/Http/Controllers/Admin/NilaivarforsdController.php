...
class NilaivarforsdController extends Controller
{
    protected $limit = 10;
    ...
    public function store(NilaivarforStoreRequest $request)
    {
        ...
        return redirect('/dashboard/variasi-formasi/sd')->with('success', 'Nilai berhasil ditambahkan!');
    }
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($nilaivarfors->exists()) {
            ...
            $nilaivarfors->delete();
            return redirect('/dashboard/variasi-formasi/sd')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/variasi-formasi/sd')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}