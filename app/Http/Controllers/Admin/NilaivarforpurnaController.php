...
use App\Http\Requests\Admin\NilaivarforUpdateRequest;
...
class NilaivarforpurnaController extends Controller
{
    protected $limit = 10;
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.variasiformasi.sd.data', [
    ...
    public function create()
    {
        ...
        return view('pages.admin.variasiformasi.sd.create', [
    ...
    public function store(NilaivarforStoreRequest $request)
    {
        ...
        return redirect('/dashboard/variasi-formasi/purna')->with('success', 'Nilai berhasil ditambahkan!');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $jenisVariasis = Jenis::where('tipe', '=', '3VARIASI')
            ->whereHas('tingkatan', function ($query) {
                $query->where('nama_tingkatan', 'Purna/Manajemen');
            })
            ->orderBy('urutan')
            ->get();
        ...
        return view('pages.admin.variasiformasi.sd.show', [
            'title'          => $title,
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($nilaivarfors->exists()) {
            ...
            $nilaivarfors->delete();
            return redirect('/dashboard/variasi-formasi/purna')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/variasi-formasi/purna')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}