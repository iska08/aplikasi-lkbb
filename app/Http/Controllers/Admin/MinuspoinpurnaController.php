...
class MinuspoinpurnaController extends Controller
{
    protected $limit = 10;
    ...
    public function index()
    {
        ...
        return view('pages.admin.minuspoin.purna.data', [
    ...
    public function create()
    {
        ...
        return view('pages.admin.minuspoin.purna.create', [
    ...
    public function store(MinuspoinStoreRequest $request)
    {
        ...
        return redirect('/dashboard/minus-poin/purna')->with('success', 'Pengurangan Nilai Berhasil Ditambahkan!');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.admin.minuspoin.purna.show', [
            'title'        => $title,
            'id'           => $id,
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.minuspoin.purna.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/dashboard/minus-poin/purna')->with('success', 'Pengurangan Nilai Berhasil Diperbarui!');
    }
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($minuspoins->exists()) {
            ...
            $minuspoins->delete();
            return redirect('/dashboard/minus-poin/purna')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/minus-poin/purna')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}