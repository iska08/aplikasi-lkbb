...
class NilaivarforsmaController extends Controller
{
    protected $limit = 10;
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.variasiformasi.sma.data', [
    ...
    public function create()
    {
        ...
        return view('pages.admin.variasiformasi.sma.create', [
    ...
    public function store(NilaivarforStoreRequest $request)
    {
        ...
        return redirect('/dashboard/variasi-formasi/sma')->with('success', 'Nilai berhasil ditambahkan!');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('pages.admin.variasiformasi.sma.show', [
            'title'          => $title,
    ...
    public function destroy($peserta_id)
    {
        ...
        if ($nilaivarfors->exists()) {
            ...
            $nilaivarfors->delete();
            return redirect('/dashboard/variasi-formasi/sma')->with('success', 'Semua Nilai yang Berhubungan Telah Dihapus!');
        } else {
            return redirect('/dashboard/variasi-formasi/sma')->with('error', 'Tidak Ada Data Nilai yang Ditemukan!');
        }
    }
}