    ...
    <div class="card mb-4 bg-secondary">
        <form class="col-lg-8 px-4 mt-3" method="POST" action="{{ route('pleton.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_anggota') is-invalid @enderror" id="nama_anggota" name="nama_anggota" value="{{ old('nama_anggota') }}" autofocus required placeholder="Masukkan Nama">
                @error('nama_anggota')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kelas_anggota') is-invalid @enderror" id="kelas_anggota" name="kelas_anggota" value="{{ old('kelas_anggota') }}" autofocus required placeholder="Masukkan Kelas">
                @error('kelas_anggota')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nis_anggota') is-invalid @enderror" id="nis_anggota" name="nis_anggota" value="{{ old('nis_anggota') }}" autofocus required placeholder="Masukkan NIS">
                @error('nis_anggota')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <a href="{{ route('pleton.index') }}" class="btn btn-danger mb-3">Cancel</a>
        </form>
    </div>
</div>
@endsection