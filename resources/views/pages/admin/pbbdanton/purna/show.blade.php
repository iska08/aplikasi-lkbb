        ...
        <div class="row align-items-center">
            <div class="col-sm-6 col-md-12">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pbb-danton-purna.index') }}">Data Nilai PBB dan Danton</a></li>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead class="bg-dark align-middle text-center text-white">
                            <tr>
                                <th colspan="3" class="fw-bold bg-dark">{{ $jenisPBB->jenis_name }}</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @if ($filterAbaabaPBB->count())
                                ...
                                <tr>
                                    ...
                                    @php
                                        $filterNilai = $nilaipbbdantons->where('user_id', auth()->user()->id)->where('abaaba_id', $abaabaPBB->id)->first();
                                    @endphp
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead class="bg-dark align-middle text-center text-white">
                            <tr>
                                <th colspan="3" class="fw-bold bg-dark">{{ $jenisDanton->jenis_name }}</th>
                            </tr>
                            <tr>
                                <th style="width: 5%">No</th>
                                <th>Nama Aba-Aba/Penilaian</th>
                        ...
                        <tbody>
                            ...
                            @if ($filterAbaabaDanton->count())
                                ...
                                <tr>
                                    ...
                                    @php
                                        $filterNilai = $nilaipbbdantons->where('user_id', auth()->user()->id)->where('abaaba_id', $abaabaDanton->id)->first();
                                    @endphp
                                    <td class="text-center">{{ $filterNilai ? $filterNilai->points : '0' }}</td>
                                </tr>
                                @endforeach
