    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 bg-secondary">
            <div class="card-body">
                ...
                <a href="{{ route('pbb-danton-purna.create') }}" type="button" class="btn btn-dark mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('pbb-danton-purna.show', $nilaipbbdanton->user_id) }}" class="badge bg-info">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    @if(auth()->user()->level === '1ADMIN')
                                    <form action="{{ route('pbb-danton-purna.destroy', $nilaipbbdanton->id) }}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
