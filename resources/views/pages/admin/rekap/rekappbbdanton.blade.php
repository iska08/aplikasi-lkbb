                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td @if ($pesertas->where('rank_utama', $peserta->rank_utama)->count() > 1) style="background-color: #dc3545; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 1 || $peserta->rank_utama === 2 || $peserta->rank_utama === 3) style="background-color: #FFFF99; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 4 || $peserta->rank_utama === 5 || $peserta->rank_utama === 6) style="background-color: #99FF99; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 7 || $peserta->rank_utama === 8 || $peserta->rank_utama === 9) style="background-color: #99FFFF; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 10 || $peserta->rank_utama === 11 || $peserta->rank_utama === 12) style="background-color: #FFD699; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 13 || $peserta->rank_utama === 14 || $peserta->rank_utama === 15) style="background-color: #D8BFD8; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 16 || $peserta->rank_utama === 17 || $peserta->rank_utama === 18) style="background-color: #99CCFF; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 19 || $peserta->rank_utama === 20 || $peserta->rank_utama === 21) style="background-color: #FFCCCB; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 22 || $peserta->rank_utama === 23 || $peserta->rank_utama === 24) style="background-color: #D3D3D3; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 25 || $peserta->rank_utama === 26 || $peserta->rank_utama === 27) style="background-color: #D2B48C; vertical-align: middle !important;"
                                    @elseif ($peserta->rank_utama === 28 || $peserta->rank_utama === 29 || $peserta->rank_utama === 30) style="background-color: #4682B4; vertical-align: middle !important;"
                                    @else style="vertical-align: middle !important;"
                                    @endif
                                >
                                    {{ $peserta->rank_utama }}
