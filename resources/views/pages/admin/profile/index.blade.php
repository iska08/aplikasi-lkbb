...
<div class="container-fluid px-4">
    ...
    {{-- datatable --}}
    <div class="card col-lg-12 bg-secondary">
        <div class="card-body">
            <div class="row justify-content-between">
                <form class="col-lg-8 border-end pe-4" method="POST" action="{{ route('profile.update', $userData->id) }}" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-dark mb-3 mt-1">Simpan Perubahan Profile</button>
                </form>
                {{-- Ubah Password --}}
                <form class="col-lg-4 ps-4" action="{{ route('profile.update', $userData->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-dark mt-1">Perbarui Password</button>
                </form>
            </div>
        </div>
    </div>
