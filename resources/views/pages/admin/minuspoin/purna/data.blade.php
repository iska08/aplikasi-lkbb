...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 bg-secondary">
            <div class="card-body">
                <a href="{{ route('minus-poin-purna.create') }}" type="button" class="btn btn-dark mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('minus-poin-purna.show', $minuspoin->id) }}" class="badge bg-info">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="{{ route('minus-poin-purna.edit', $minuspoin->id) }}" class="badge bg-warning">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <form action="{{ route('minus-poin-purna.destroy', $minuspoin->id) }}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
