        ...
        <div class="row align-items-center">
            <div class="col-sm-6 col-md-12">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('minus-poin-purna.index') }}">Data Pengurangan Nilai</a></li>
                    <li class="breadcrumb-item active">{{ $title }}</li>
                </ol>
            </div>
        </div>
        <div class="card mb-4 bg-secondary">
            <form class="px-4" action="{{ route('minus-poin-purna.update', $peserta->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <a href="{{ route('minus-poin-purna.index') }}" class="btn btn-danger mb-3">Kembali</a>
            </form>
        </div>
    </div>
</main>
